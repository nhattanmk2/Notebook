...
public class AllCourseAdapter extends RecyclerView.Adapter<AllCourseAdapter.CourseViewHolder> implements Filterable {

    private Context mContext;
    private List<Subject> mListCourse;
    List<Subject> mListCourseRoot;

    public AllCourseAdapter(Context mContext, List<Subject> mListCourse) {
